...
public class SerializeHelper
{
    public static T ReadDataFromXmlFile<T>(string fileName, bool useDataContractSerialize = false) where T : class
    {
        try
        {
            using (StreamReader streamReader = new StreamReader(fileName))
            {
                ...
                T result = useDataContractSerialize ? DataContractSerializeDeserialize<T>(xmlData) : XmlSerializerDeserialize<T>(xmlData);
    ...
    public static T XmlSerializeDeserialize<T>(string xmlData) where T : class
    {
        try
        {
    ...
    public static void SaveDataToXml<T>(string fileName, T target, bool useDataContractSerialize = false)
    {
        try
        {
            ...
            {
                string xmlData =
                    useDataContractSerialize ? DataContractSerializerSerialize(target) : XmlSerializerSerialize(target);
    ...
    public static string DataContreactSerializerSerialize<T>(T obj)
    {
        try
        {
